...
<?php 
	...
	if(isset($_REQUEST['submitAll']))
	{
		...
		$_SESSION['name'] = $name;
		$insert = "update tenantinformation set Name = '$name', Phone='$phone', Email = '$email' where Apartment = '$apt'";
	...
	{		
		$_SESSION['name'] = $name;
		$insert = "update tenantinformation set Name='$name' where Apartment = '$apt'";
		$run = mysqli_query($connection, $insert);
		echo "<br><br>You will be redirected to the homepage in 5 seconds. <br> If page does not automatically load, click here: <a href='landing.php'>Go to home page</a>";				
		header("Refresh:5; url=landing.php");
	}
	...
	{
		$_SESSION['phone'] = $phone;
		$insert = "update tenantinformation set Phone='$phone' where Apartment = '$apt'";
		$run = mysqli_query($connection, $insert);
		echo "<br><br>You will be redirected to the homepage in 5 seconds. <br> If page does not automatically load, click here: <a href='landing.php'>Go to home page</a>";				
		header("Refresh:5; url=landing.php");
	} 
	...
	{
		$_SESSION['email'] = $email;
		$insert = "update tenantinformation set Email='$email' where Apartment = '$apt'";
		$run = mysqli_query($connection, $insert);
		echo "<br><br>You will be redirected to the homepage in 5 seconds. <br> If page does not automatically load, click here: <a href='landing.php'>Go to home page</a>";				
		header("Refresh:5; url=landing.php");
	} 
